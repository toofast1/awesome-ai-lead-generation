...
- [OpenOutreach](https://github.com/eracle/OpenOutreach) - Open-source self-hosted lead finder; discovers candidates from a licensed source with no scraping, and an LLM qualifies each one and writes down why.
