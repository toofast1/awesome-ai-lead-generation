...
- [Hanzi](https://github.com/hanzili/hanzi-in-chrome) - Open-source AI agent that automates LinkedIn prospecting from your real browser. Finds prospects, reads their profiles, writes personalized connection notes, and asks for approval before sending.
